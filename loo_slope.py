...
def main() -> None:
    ...
    # One row per (L, eps); take the peak chi for each L
    peaks = (
    ...
    # Full fit
    gnu_full, A_full = fit_power_law(Ls, chi_max)
    ...
    # Left: chi_max vs L with full fit and K&D
    ax = axes[0]
    ...
    path = os.path.join(outdir, "loo_slope.png")
    fig.tight_layout()
