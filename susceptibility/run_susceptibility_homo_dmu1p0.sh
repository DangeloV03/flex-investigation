...
EQ_TIME=100000.0
# Default production time: the 5x multiplier setting validated by multiplier_test/
# (peak chi vs L converged, gamma/nu ~ 1.71 consistent with K&D 1.73). chunk_time =
# PROD_TIME / PROD_CHUNKS = 100 stays fixed, so "5x" means more samples, same cadence.
PROD_TIME=1000000.0
PROD_CHUNKS=10000
SEED_BASE=7000
