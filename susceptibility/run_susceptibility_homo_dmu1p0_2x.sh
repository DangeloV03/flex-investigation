#!/bin/bash
#SBATCH --job-name=susc_homo_dmu1p0_2x
#SBATCH --ntasks=1
...
#
# Driven homo scheme-1 susceptibility run at 2x the 1x baseline eq+prod time,
...
# 2x the driven 1x baseline (EQ 100000, PROD 1000000, CHUNKS 10000). Both eq and
# prod time double; PROD_CHUNKS doubles too so chunk_time = PROD/CHUNKS = 100 is
