...
PHASE_CONFIG = {
    ...
    "exact_split": {
        "runner": "susceptibility_runner.py",
        "manifest": EXACT_SPLIT_MANIFEST,
        "samples_root": EXACT_SPLIT_SAMPLES_DIR,
    },
}
...
def submit_up_to_cap(
    *,
    ...
    while True:
        ...
        elif phase == "exact_split":
            patch_job = patch_exact_split_job_json
        else:
...
def main() -> None:
    ...
    parser.add_argument(
        "--phase",
        choices=["coex", "prod", "exact", "exact_random", "exact_split"],
        required=True,
